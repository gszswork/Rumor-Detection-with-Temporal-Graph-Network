...
class EmbeddingModule(nn.Module):
  def __init__(self, time_encoder, n_layers,
    ...
    # self.memory = memory
    #self.neighbor_finder = neighbor_finder # 从参数中去掉neighbour_finder, 只在compute_embeeding中作为参数输入
  ...
  def compute_embedding(self, memory, node_features, edge_features, neighbor_finder, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
                        use_time_proj=True):
    pass
...
class GraphEmbedding(EmbeddingModule):
  ...
  def compute_embedding(self, memory, node_features, edge_features,  neighbor_finder, source_nodes, timestamps, n_layers, n_neighbors=20, time_diffs=None,
    ...
    source_node_features = node_features[source_nodes_torch, :]
    ...
    if n_layers == 0:
      ...
      edge_features = edge_features[edge_idxs, :]
...
class GraphAttentionEmbedding(GraphEmbedding):
  def __init__(self,
    ...
    super(GraphAttentionEmbedding, self).__init__(
                                                  ...
                                                  n_heads, dropout,
                                                  use_memory)
    # Only number of node_features are used.
    self.attention_models = torch.nn.ModuleList([TemporalAttentionLayer(
      n_node_features=n_node_features,   # dimensin of node features.
