...
class GraphEmbedding(EmbeddingModule):
    ...
    def my_compute_embedding(self, source_nodes, destination_nodes, source_timestamps, destination_timestamps, n_neighbors=50,
        ...
        neighbors_torch = torch.from_numpy(n_neighbors).long().to(self.device)
        ...
        sub_graph_embedding = self.temporal_attention(source_node_features, source_node_time_embedding,
